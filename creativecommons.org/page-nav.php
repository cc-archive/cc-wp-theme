  ...
  <nav class="navbar navbar-default">
	...
	<li class="dropdown">
	  <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Support CC <span class="caret"></span></a>
     	  <ul class="dropdown-menu">
	    <!-- <li><a href="https://donate.creativecommons.org">Donate to Creative Commons</a> -->
	    <li><a href="https://www.kickstarter.com/projects/creativecommons/made-with-creative-commons-a-book-on-open-business">Donate to Creative Commons</a></li>
